...
additionalProperties:
  packageGuid: '{B577B1AF-0DA1-4751-8B6C-6671BB5896B8}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IInventoryApi>();
            IListItemsApiResponse apiResponse = await api.ListItemsAsync("todo");
            List<Item>? model = apiResponse.Ok();
        }
