...
namespace ShopApi.Users.Api
{
    ...
    public interface ICreateUserApiResponse : ShopApi.Users.Client.IApiResponse, ICreated<ShopApi.Users.Model.User?>
    {
        bool IsCreated { get; }
    }

    public interface IGetUserApiResponse : ShopApi.Users.Client.IApiResponse, IOk<ShopApi.Users.Model.User?>
    {
        bool IsOk { get; }
    ...
    public interface IListUsersApiResponse : ShopApi.Users.Client.IApiResponse, IOk<List<User>?>
    {
        bool IsOk { get; }
    }
    ...
    public sealed partial class UsersApi : IUsersApi
    {
        ...
        public partial class CreateUserApiResponse : ShopApi.Users.Client.ApiResponse, ICreateUserApiResponse
        {
            ...
            public ShopApi.Users.Model.User? Created()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsCreated
                    ? System.Text.Json.JsonSerializer.Deserialize<ShopApi.Users.Model.User>(RawContent, _jsonSerializerOptions)
                    : null;
            }

            public bool TryCreated([NotNullWhen(true)]out ShopApi.Users.Model.User? result)
            {
                result = null;
        ...
        public partial class GetUserApiResponse : ShopApi.Users.Client.ApiResponse, IGetUserApiResponse
        {
            ...
            public ShopApi.Users.Model.User? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<ShopApi.Users.Model.User>(RawContent, _jsonSerializerOptions)
            ...
            public bool TryOk([NotNullWhen(true)]out ShopApi.Users.Model.User? result)
            {
                result = null;
        ...
        public partial class ListUsersApiResponse : ShopApi.Users.Client.ApiResponse, IListUsersApiResponse
        {
